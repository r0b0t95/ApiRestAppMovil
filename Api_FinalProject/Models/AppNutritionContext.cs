        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ExerciseRoutine>(entity =>
            {
                entity.HasKey(e => e.IdRoutine)
                    .HasName("PK__exercise__99D02BFF39675FDB");
            ...
            modelBuilder.Entity<NutritionalPlan>(entity =>
            {
                entity.HasKey(e => e.IdPlan)
                    .HasName("PK__nutritio__BECFB99695DAFF2B");
            ...
            modelBuilder.Entity<Reminder>(entity =>
            {
                entity.HasKey(e => e.IdReminder)
                    .HasName("PK__Reminder__567582FDF0CB3BEE");
            ...
            modelBuilder.Entity<State>(entity =>
            {
                entity.HasKey(e => e.IdState)
                    .HasName("PK__State__98CB37232312ABBD");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                entity.HasKey(e => e.IdUser)
                    .HasName("PK__Users__3717C982148A9CAC");
